...
│                  (OpenAI API, ~$0.0015-0.003/chunk, GPT-4o-mini)   │
└─────────────────────────────────────────────────────────────────────┘
...
- **Cost**: ~$0.0015-0.003 per chunk (GPT-4o-mini)
- **Bottleneck**: API rate limits
- **Scalability**: Network-bound, batch-friendly

### Example: 1000 Documents
- **Stage 1**: ~1-2 hours, $0
- **Stage 2**: ~3-5 hours, $1.50-$3.00
- **Total**: ~4-7 hours, $1.50-$3.00

**Note**: Costs based on GPT-4o-mini pricing ($0.15/1M input tokens, ~$0.60/1M output tokens). Always test with a small batch first and monitor your actual usage.
